...
public class EntitySearchEntry : Form
{
	...
	private void BnO7rgU31r()
	{
		...
		tLwAfM1ddQ.ValueMember = Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(10936);
		tLwAfM1ddQ.DisplayMember = Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(11118);
		tLwAfM1ddQ.DataSource = new BindingSource(Constants.dimensionNames, null);
		Settings settings = new Settings();
		b5QApmKOSH.Text = settings.LastEntitySearch;
		tLwAfM1ddQ.SelectedValue = settings.LastEntitySearchRegion;
	...
	private void hNJ76TDSyq()
	{
		...
		if (!string.IsNullOrWhiteSpace(b5QApmKOSH.Text))
		{
			...
			string dimension = (string)tLwAfM1ddQ.SelectedValue;
			...
			settings.LastEntitySearchRegion = (string)tLwAfM1ddQ.SelectedValue;
