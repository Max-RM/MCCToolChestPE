...
public class DimensionMap : Form
{
	...
	private void cnGQljMDFO()
	{
		...
		V5vOBUHAqH.ValueMember = Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(10936);
		V5vOBUHAqH.DisplayMember = Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(11118);
		V5vOBUHAqH.DataSource = new BindingSource(Constants.dimensionNames, null);
	...
	private void eXXQavmJEH()
	{
		...
		string dimension = (string)V5vOBUHAqH.SelectedValue;
	...
	private void SX7Q853qjY(AreaActionType P_0)
	{
		...
		e.Dimension = V5vOBUHAqH.SelectedIndex;
		switch (P_0)
		{
