...
public class MapDimension : UserControl
{
	...
	private void c9rmWonsyE(Graphics P_0, PEDimension P_1)
	{
		...
		string path = Path.Combine(Working.T92StMGt1p4(), Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(20428), Constants.dimensionFolderNames[P_1.Dimension]);
	...
	public void SaveMaps(string imagePath)
	{
		...
		int num = 6144;
		PEDimension pEDimension = PEUtility.GetPEDimension(dpYnz7GUrv.Dimension);
		string path = Path.Combine(Working.T92StMGt1p4(), Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(20428), Constants.dimensionFolderNames[pEDimension.Dimension]);
