...
public class RegionDisplay : UserControl
{
	...
	public PERegion RegionEntry
	{
		...
		set
		{
			...
			if (value != null)
			{
				string text = Constants.dimensionNames[Constants.dimensionFolderNames[iPvXaJoxEh.Dimension]];
	...
	private void G22Xp8mgbd(MouseEventArgs P_0)
	{
		...
		if (num > 10 && num2 > 20)
		{
			...
			if (num < TKmXhZtYmd && num2 < TKmXhZtYmd && dfNXXJ1M2k[num][num2].IsPresent)
			{
				...
				string dimension = Constants.dimensionFolderNames[iPvXaJoxEh.Dimension];
