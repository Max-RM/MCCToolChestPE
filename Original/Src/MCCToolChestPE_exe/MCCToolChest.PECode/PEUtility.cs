...
public class PEUtility
{
	...
	public static PEDimension GetPEDimension(string dimension)
	{
		...
		if (dimension == Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(21936))
		{
			result = Working.PEDimensions[0];
		}
		else if (dimension == Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(43780))
		{
			result = Working.PEDimensions[1];
		}
		else if (dimension == Ne4dSgXrbYTX6VcmT1p.mqbSrBrZa1U(43794))
		{
