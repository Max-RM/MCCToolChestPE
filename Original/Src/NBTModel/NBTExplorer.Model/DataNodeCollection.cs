...
public class DataNodeCollection : IList<DataNode>, ICollection<DataNode>, IEnumerable<DataNode>, IEnumerable
{
	...
	bool ICollection<DataNode>.IsReadOnly => ((ICollection<DataNode>)_nodes).IsReadOnly;
	...
	public void RemoveAt(int index)
	{
		...
		DataNode dataNode = _nodes[index];
