...
public class WildcardRuleForm : Form
{
	...
	public WildcardOperator Operator
	{
		get
		{
			return (WildcardOperator)_selectOperator.SelectedItem;
		}
		set
		{
	...
	{
		InitializeComponent();
		foreach (KeyValuePair<WildcardOperator, string> @operator in operators)
		{
