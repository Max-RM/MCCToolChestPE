...
public interface ITypeInfo
{
	...
	void RemoteGetTypeAttr([Out] IntPtr ppTypeAttr, [ComAliasName("PortableDeviceApiLib.DWORD")] out uint pDummy);

	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void GetTypeComp([MarshalAs(UnmanagedType.Interface)] out ITypeComp ppTComp);

	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void RemoteGetFuncDesc([In] uint index, [Out] IntPtr ppFuncDesc, [ComAliasName("PortableDeviceApiLib.DWORD")] out uint pDummy);

	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void RemoteGetVarDesc([In] uint index, [Out] IntPtr ppVarDesc, [ComAliasName("PortableDeviceApiLib.DWORD")] out uint pDummy);
