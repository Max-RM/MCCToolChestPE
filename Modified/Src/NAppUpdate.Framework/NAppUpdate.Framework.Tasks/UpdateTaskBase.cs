...
[Serializable]
public abstract class UpdateTaskBase : IUpdateTask, INauFieldsHolder
{
	[NonSerialized]
	...
	public BooleanCondition UpdateConditions
	{
		get
		{
			return _updateConditions ?? (_updateConditions = new BooleanCondition());
		}
		set
		{
			_updateConditions = value;
		}
	}
