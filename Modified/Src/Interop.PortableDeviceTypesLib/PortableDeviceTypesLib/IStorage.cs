...
public interface IStorage
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void OpenStorage([In][MarshalAs(UnmanagedType.LPWStr)] string pwcsName, [In][MarshalAs(UnmanagedType.Interface)] IStorage pstgPriority, [In] uint grfMode, [In][ComAliasName("PortableDeviceTypesLib.wireSNB")] ref tagRemSNB snbExclude, [In] uint reserved, [MarshalAs(UnmanagedType.Interface)] out IStorage ppstg);

	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void RemoteCopyTo([In] uint ciidExclude, [In] ref Guid rgiidExclude, [In][ComAliasName("PortableDeviceTypesLib.wireSNB")] ref tagRemSNB snbExclude, [In][MarshalAs(UnmanagedType.Interface)] IStorage pstgDest);
